...
const loginWithEmailAndPassword = ()=> {
    ...
    return navigate ? ( <Redirect to='/dashboard/v1' />) :  (
        ...
        <div className="container">
            <nav className="main-nav">
                <a href="#0" className="search-trigger mobile-search"><span className="fa fa-search"></span></a>
                ...
                <div className="nav-right">
                    <ul className="nav" role="menu">
                        <li><a className="nav-current" href="index.html">Home</a></li>
                        <li><a href="resellers/index.html">About</a></li>
                        <li><a href="developers/index.html">Invite a friend</a></li>
                        {/* <li>
                            <a href="features/index.html">Features <i className="fa fa-angle-down"></i></a>
                            <div className="nav-menu-dropdown">
                                <ul>
                                    <li><a className="tab-trigger" href="features/index.html#software" data-tab="#tab-2">Software</a></li>
                                    <li><a className="tab-trigger" href="features/index.html#hardware" data-tab="#tab-1">Hardware</a></li>
                                </ul>
                            </div>
                        </li> */}
                    </ul>
                    <div className="split"></div>
                    <a href="#0" className="search-trigger"><span className="fa fa-search"></span></a>
                        <button className="white-outline secondary-btn-small" onClick={toggleSignIn}>Log In</button>
                
                        <button className="white-outline primary-btn-small" id="cta-topnav-getpoynt" onClick={toggleSignUp}><i className="i-Add-User"></i> Become a Seller</button>
                </div>
            </nav>
        </div>
    </header>
